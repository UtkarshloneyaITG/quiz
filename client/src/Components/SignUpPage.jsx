...
export default function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[900px] bg-gradient-to-r from-purple-600 to-indigo-600 px-4">
      ...
      >
        <h1 className="text-4xl font-bold mb-4">{page == "dummydata" ? 'Sign-up' : "Add " + page}</h1>
        {/* Full Name */}
        ...
        >
          {page == "dummydata" ? 'Sign-up' : "Add " + page}
        </button>
        {page == "dummydata" ? (
          <Link to="/login">
