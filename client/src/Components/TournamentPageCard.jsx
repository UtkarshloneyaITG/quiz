...
function TournamentPageCard({ title, type, date, time }) {
  ...
  return (
    <div>
      {showInformation && (
        <TurnamentInfo title={title} type={type} date={date} time={time} handleClose={handleClose}/>
      )}

      
        <div onClick={()=> setInformation(true)} className="weekly-tournaments-page-card bg-gradient-to-r from-purple-500 to-purple-900 w-fit p-5 rounded-2xl relative shadow-[#0007] shadow-2xl border-2 border-purple-600">
            ...
            <div className="weekly-tournaments-page-card-rules pt-3 text-[10px] ">
              ...
              {type == "wt" ? (
                ...
                <ul className="text-left text-white">
                  ...
                  <li>
                    Unfair means or multiple logins will lead to
                    disqualification.
                  </li>
