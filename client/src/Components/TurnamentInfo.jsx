...
function TurnamentInfo({ title, type, date, time , handleClose }) {
 ...
 <div className="flex-[0.6] bg-gradient-to-br from-[#2a0845] to-[#6441a5] rounded-xl p-4 shadow-inner flex flex-col justify-between">
    ...
    <div className="text-center mt-2 md:mt-4">
      <button className="bg-amber-400 hover:bg-amber-300 text-black font-semibold text-sm md:text-lg px-6 py-2 md:px-8 md:py-2 rounded-lg transition-transform duration-300 hover:scale-105">
        Enter Tournament
      </button>
    </div>
  </div>
  ...
  <div className="flex-[0.4] bg-gradient-to-br from-[#093028] to-[#237a57] rounded-xl p-4 flex flex-col items-center justify-center gap-2 md:gap-4 text-center shadow-inner">
    ...
    <div className="space-y-1 md:space-y-2 text-xs md:text-lg">
      <p>
        <span className="text-amber-300 font-semibold">Start Time:</span> {time}
      </p>
      <p>
        <span className="text-amber-300 font-semibold">End Time:</span> {time}
      </p>
      <p>
        <span className="text-amber-300 font-semibold">Date:</span> {date}
      </p>
      <p>
        <span className="text-amber-300 font-semibold">Language:</span> {title}
      </p>
    </div>
